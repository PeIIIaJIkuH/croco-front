...
import {IconArrowBackUp, IconArrowForwardUp, IconEraser, IconPencil, IconPoint, TablerIcon} from '@tabler/icons'
...
type Type = 'pencil' | 'eraser' | 'undo' | 'redo'
